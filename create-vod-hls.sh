...
# IMPORTANT -profiel:v main brings up error
# change h264 -> libx265
# adding -preset medium or slow if you dont have life
static_params="-c:a aac -ar 48000 -c:v libx265 -preset medium -crf 20 -sc_threshold 0"
